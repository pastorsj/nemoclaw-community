...
| Structured prediction | `mcp__gsf__ask_question` | Returns `sql` beginning with `PREDICT` for a Kumo attempt and one or more rows that each contain a finite numeric score for success. |
