...
| [Query Claw](query-claw/README.md) | 🏭 Manufacturing | Routes enterprise questions through structured facts, retrieved documents, and predictive analytics, then returns one evidence-led answer from Hermes inside OpenShell. |
